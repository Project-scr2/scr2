...
#'
#' @description This function computes the number of last consecutive returns with same sign for
#' a given stock. For instance, if the last sign is positive, the output would be the number of
#' last consecutive positive signs.
#'
